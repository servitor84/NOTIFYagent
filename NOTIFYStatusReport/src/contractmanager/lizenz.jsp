...
<fmt:bundle basename="de.di.notifyagent.web.resource.servlet">
<html>
<head>
...
<%
            Application app = (Application) application.getAttribute(AgentServlet.agentAttribute);
            if (app != null && app.isAlive()) {
                java.util.Map<String, String> status = app.getStatus();
...
<tr>    
        ...
        <td> 
            <div class="name"><fmt:message key="page.licence.header.text"></fmt:message> <b>DOK</b>inform<sup>&#174;</sup> <b>Contract</b><i>Manager</i></div>
        </td>
    </tr>
	</table>
<hr>
